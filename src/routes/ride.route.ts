...
import { acceptRide, completeRide, createRide, findNearbyDrivers, getAvailableRides } from "../controllers/ride.controller";
...
router.get("/", authenticateUser, authorizeRole(["rider"]), getAvailableRides);
